...
# %% auto 0
__all__ = ['inbound', 'outbound', 'population', 'GDP', 'country_names', 'complete_data', 'col', 'select_data', 'make_heatmap',
           'make_choropleth', 'calculate_arrivals_difference', 'make_donut', 'format_number']
